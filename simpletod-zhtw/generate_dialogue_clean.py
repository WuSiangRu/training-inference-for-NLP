...
model_checkpoint = r"simpletod_specialadded_rl_03"
        ...
        if (
            ...
            with torch.no_grad():
                ...
                if decoding == "nucleus":
                    ...
                    greedy_sample_output = model.generate(
                        tokens_tensor, max_length=MAX_LEN
                    )
                    predicted_text = tokenizer.decode(greedy_sample_output[0])
                    tmp = " ".join(
                        [
                            predicted_text.split("<|endofresponse|>")[0],
                            "<|endofresponse|>",
