...
#model_checkpoint = r"simpletod_specialadded_en_rl_04"
#model_checkpoint = r"en_first_fine_tune_with_rdrop"
#model_checkpoint = r"baseline_final_5584"

#end2end:
model_checkpoint = r"../custom_trainer_samuel/en_baseline_end2end_ver4"
...
for i, dial_name in enumerate(lex_dict):
    ...
    for turn_id, (usr_turn, _) in enumerate(zip(user, system)):
        ...
        indexed_tokens = tokenizer.encode(text + "<|belief|>")
        ...
        if (
            ...
            with torch.no_grad():
                ...
                if decoding == "nucleus":
                    ...
                    predicted_text = (
                        tokenizer.decode(greedy_output[0]) + "<|endoftext|>"
                    )
